...
# Build command :
#   DOCKER_BUILDKIT=1 docker build --rm -f 8.3-laravel.Dockerfile -t haidarns/php:8.3-laravel-nginx --no-cache .

# FROM haidarns/php:8.3-laravel-nginx as GRPC_SOURCE
FROM php:8.3-fpm
